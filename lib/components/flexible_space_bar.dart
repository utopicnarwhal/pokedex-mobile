...
class PokedexFlexibleSpaceBar extends StatefulWidget {
  /// Creates a flexible space bar.
  ///
  /// Most commonly used in the [AppBar.flexibleSpace] field.
  const PokedexFlexibleSpaceBar({
    Key key,
    this.title,
    this.background,
    this.centerTitle,
  ...
  /// [DsFlexibleSpaceBar] when fully collapsed. `maxExtent` sets the maximum
  /// height of the resulting [DsFlexibleSpaceBar] when fully expanded.
  /// `currentExtent` sets the scale of the [DsFlexibleSpaceBar.background] and
  /// [DsFlexibleSpaceBar.title] widgets of [DsFlexibleSpaceBar] upon
  /// initialization.
  ///
  /// See also:
  ///
  ///  * [DsFlexibleSpaceBarSettings] which creates a settings object that can be
  ///    used to specify these settings to a [DsFlexibleSpaceBar].
  ...
  @override
  _PokedexFlexibleSpaceBarState createState() => _PokedexFlexibleSpaceBarState();
}

class _PokedexFlexibleSpaceBarState extends State<PokedexFlexibleSpaceBar> {
